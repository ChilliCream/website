...
dotnet tool install StrawberryShake.Tools --version 11.0.0-preview.24 --local
```
...
The next command `dotnet tool install StrawberryShake.Tools --version 11.0.0-preview.24 --local` installs our _Strawberry Shake_ tools.
...
cd BerryClient
dotnet add package StrawberryShake --version 11.0.0-preview.24
